...
export default function ContactUsForm() {
    ...
    return (
        <form onSubmit={handleSubmit(submitFormHandler)} className="space-y-8">
            ...
            ), [errors.email, errors.firstName, errors.lastName, errors.message, register])}
            <div className="flex justify-between items-center">
                <Checkbox
                    ...
                    }}>I agree with Terms of Use and Privacy Policy</Checkbox>
                <Button className="text-white bg-red-45 dark:bg-red-45/80" type="submit" isDisabled={!isAccetpedRules}>Send Message</Button>
            </div>
        </form>
    )
}
