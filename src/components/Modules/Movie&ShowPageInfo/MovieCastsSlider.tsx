  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-10">
        <h3 className="text-lg text-gray-60">Casts</h3>
        <div className="flex items-center gap-2.5 child:cursor-pointer child:bg-black-8 child:p-3.5 child:rounded-full">
