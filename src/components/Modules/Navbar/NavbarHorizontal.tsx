...
export default function NavbarHorizontal({ triggerNavbarVertical }: {
        ...
        >
            ...
            >
                ...
                <NavbarItem className="flex items-center gap-3">
                    ...
                    <div className="md:hidden flex items-center justify-center w-10 h-10 bg-gray-85 dark:bg-black-10 border-2 dark:border-black-15 rounded-lg cursor-pointer" onClick={triggerNavbarVertical}>
